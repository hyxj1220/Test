...
　　fsfortuneで
gunzip /home/fsfortune/site/lovemi/lovemi.user.txt.gz

2.fsfortuneで、下記のスクリプトを行う
/usr/local/bin/php /home/fsfortune/site/lovemi/__copy_user_script.php
 */

// クラス、設定読み込み
require_once("/home/fsfortune/site/lovemi/user/public_html/user_include.inc");
...
$contents = file_get_contents("/home/fsfortune/site/lovemi/lovemi.user.txt");
